...
```powershell
msiexec.exe /i Hataori-3.0.2.0-x64.msi INSTALL_ROOT="D:\Hataori"
```
...
```powershell
msiexec.exe /x Hataori-3.0.2.0-x64.msi
```
...
Get-FileHash ./artifacts/installer/Hataori-3.0.2.0-x64.msi -Algorithm SHA256
```
