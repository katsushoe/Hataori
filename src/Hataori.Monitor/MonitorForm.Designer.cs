...
partial class MonitorForm
{
    ...
    private Button cancelTaskButton = null!;
    private Button cancelRunButton = null!;
    ...
    private DataGridView runGrid = null!;
    ...
    private void InitializeComponent()
    {
        ...
        cancelTaskButton.AutoSize = true;
        cancelTaskButton.Enabled = false;
        cancelTaskButton.Click += CancelTaskButtonClick;
        cancelRunButton.AutoSize = true;
        cancelRunButton.Enabled = false;
        cancelRunButton.Click += CancelRunButtonClick;
        connectionStatusLabel.AutoSize = true;
        connectionStatusLabel.Margin = new Padding(12, 8, 3, 3);
        connectionStatusLabel.Text = "未接続";
        toolbar.Controls.Add(refreshButton);
        toolbar.Controls.Add(cancelTaskButton);
        toolbar.Controls.Add(cancelRunButton);
        toolbar.Controls.Add(connectionStatusLabel);
        tabs.Dock = DockStyle.Fill;
        tasksPage.Text = "Task";
        agentsPage.Text = "Agent";
        sessionsPage.Text = "Conversation / Session";
        runsPage.Text = "Agent Run";
        statusPage.Text = "状態";
        tasksPage.Controls.Add(taskGrid);
        agentsPage.Controls.Add(agentGrid);
        sessionsPage.Controls.Add(sessionGrid);
        runsPage.Controls.Add(runGrid);
        tabs.TabPages.AddRange([tasksPage, agentsPage, sessionsPage, runsPage, statusPage]);
        taskGrid.SelectionChanged += GridSelectionChanged;
        runGrid.SelectionChanged += GridSelectionChanged;
